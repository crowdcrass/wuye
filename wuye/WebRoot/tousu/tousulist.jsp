...
<input type="submit" value="搜索">
  ...
  <a href="method!tousuadd"><span style="font-size: 25px;">添加新的投诉信息</span></a>  
  ...
  <tbody>
    ...
    <tr>
      ...
      <a href="method!tousuupdate?id=${bean.id }"><span style="font-size: 15px;">更新投诉信息</span></a>
      <a href="method!tousudelete?id=${bean.id }"><span style="font-size: 15px;">删除投诉信息</span></a>
      </td>
    </tr>
    </c:forEach>
